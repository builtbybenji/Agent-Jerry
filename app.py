...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [{"role": "system", "content": "You are Jerry, a real estate deal analyzer assistant..."}]
...
if user_input:
    ...
    if parsed:
        ...
        if data and "data" in data and data["data"].get("valuation"):
            ...
            st.warning("API data unavailable. Checking public listings...")
...
f"Description: {description_short}...\n\n"
                        ...
                        create_pdf_report(full_address, price_val, cash_offer, [scraped['description']], pdf_path, image_url=image_url)
                        break
            else:
                st.error("Could not find property data from public sources.")
    else:
